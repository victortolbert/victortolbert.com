...
const description = computed(() => {
  return descriptions.value[Math.floor(Math.random() * description.value.length)]
})
</script>
  ...
  <nav class="bg-primary-700 z-20">
    <div class="relative h-16 flex items-center justify-between">
      <div class="flex items-center gap-8 px-2 lg:px-0">
        <NuxtLink to="/" class="flex flex-shrink-0 items-center gap-3 text-lg font-bold text-gray-300 hover:text-white">
          <LogoMarkHancock class="pl-2 h-10 w-auto" />
          ...
          <div class="relative ml-4 flex-shrink-0">
            <div>
              ...
              >
                ...
                <UAvatar
                  size="sm" class="grayscale" :src="`${assetsURL}/images/people/${user.slug}.jpeg`"
                  alt="Avatar"
                />
              </button>
            </div>
        ...
        <div class="flex items-center px-5">
          <div class="flex-shrink-0">
            <img
              ...
              :src="`${assetsURL}/images/people/${user.slug}.jpeg`"
              alt=""
            >
          </div>
          <div class="ml-3">
