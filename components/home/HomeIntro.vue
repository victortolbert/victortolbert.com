...
useSeoMeta({
  ...
  description:
    'I\'m Victor, your friendly neighborhood software engineer and designer from Atlanta, GA. I specialize in building web applications and sites using JavaScript, Vue.js, React, Node, Laravel, & .NET',
})
</script>
...
<template>
  <div class="space-y-6">
    <!-- <NuxtImg
      src="https://avatars.githubusercontent.com/u/2476?v=4" alt="Victor Tolbert"
    ...
    <div>
      ...
      <p class="text-gray-900 dark:text-gray-400">
        I'm Victor, a self-taught, full-stack software engineer and designer from Atlanta, Georgia, US.
        I specialize in building web applications and sites using JavaScript, Vue.js, React, &amp; Node.
        Here, I share my experiments, nifty projects, and maybe my thoughts (mostly about tech and design).
      </p>
