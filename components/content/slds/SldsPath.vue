          ...
          <div class="slds-path__scroller_inner">
            <ul class="slds-path__nav" role="listbox" aria-orientation="horizontal" aria-labelledby="slds-path__stage-name">
              <li class="slds-path__item slds-is-current slds-is-active" role="presentation">
                <a id="path-1" aria-selected="true" class="slds-path__link" href="#" role="option" tabindex="0">
              ...
              <li class="slds-path__item slds-is-incomplete" role="presentation">
                <a id="path-2" aria-selected="false" class="slds-path__link" href="#" role="option" tabindex="-1">
                  <span class="slds-path__stage">
                    <svg class="slds-icon slds-icon_x-small" aria-hidden="true">
                      <use xlink:href="/assets/icons/utility-sprite/svg/symbols.svg#check" />
                    </svg>
              ...
              <li class="slds-path__item slds-is-incomplete" role="presentation">
                <a id="path-3" aria-selected="false" class="slds-path__link" href="#" role="option" tabindex="-1">
                  <span class="slds-path__stage">
                    <svg class="slds-icon slds-icon_x-small" aria-hidden="true">
                      <use xlink:href="/assets/icons/utility-sprite/svg/symbols.svg#check" />
                    </svg>
              ...
              <li class="slds-path__item slds-is-incomplete" role="presentation">
                <a id="path-4" aria-selected="false" class="slds-path__link" href="#" role="option" tabindex="-1">
                  <span class="slds-path__stage">
                    <svg class="slds-icon slds-icon_x-small" aria-hidden="true">
                      <use xlink:href="/assets/icons/utility-sprite/svg/symbols.svg#check" />
                    </svg>
              ...
              <li class="slds-path__item slds-is-incomplete" role="presentation">
                <a id="path-5" aria-selected="false" class="slds-path__link" href="#" role="option" tabindex="-1">
                  <span class="slds-path__stage">
                    <svg class="slds-icon slds-icon_x-small" aria-hidden="true">
                      <use xlink:href="/assets/icons/utility-sprite/svg/symbols.svg#check" />
                    </svg>
