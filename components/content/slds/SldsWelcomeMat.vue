<template>
  <section role="dialog" tabindex="-1" aria-modal="true" aria-labelledby="welcome-mat-100-label" class="slds-modal slds-fade-in-open slds-modal_small">
    <div class="slds-modal__container">
      ...
      <div id="welcome-mat-100-content" class="slds-modal__content">
          ...
          <div class="slds-welcome-mat__content slds-grid">
            <div class="slds-welcome-mat__info slds-size_1-of-2" tabindex="0" role="region">
              <div class="slds-welcome-mat__info-content">
                <h2 id="welcome-mat-100-label" class="slds-welcome-mat__info-title">
