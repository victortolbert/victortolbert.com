  ...
  <div class="slds-carousel">
    <div class="slds-carousel__stage">
      ...
      <div class="slds-carousel__panels" style="transform:translateX(--200%)">
        <div id="content-id-91" class="slds-carousel__panel" role="tabpanel" aria-labelledby="indicator-id-94">
        ...
        <div id="content-id-92" class="slds-carousel__panel" role="tabpanel" hidden="" aria-labelledby="indicator-id-95">
      ...
      <ul class="slds-carousel__indicators" role="tablist">
        <li class="slds-carousel__indicator" role="presentation">
          <a id="indicator-id-94" class="slds-carousel__indicator-action slds-is-active" href="#" role="tab" tabindex="0" aria-selected="true" aria-controls="content-id-91" title="Visit App Exchange tab">
            <span class="slds-assistive-text">Visit App Exchange tab</span>
          </a>
        </li>
        <li class="slds-carousel__indicator" role="presentation">
          <a id="indicator-id-95" class="slds-carousel__indicator-action" href="#" role="tab" tabindex="-1" aria-selected="false" aria-controls="content-id-92" title="Click to Customize tab">
