            ...
            <div class="slds-tabs_default">
              <ul class="slds-tabs_default__nav" role="tablist">
                <li class="slds-tabs_default__item slds-is-active" title="Default" role="presentation">
                  <a id="color-picker-default__item" class="slds-tabs_default__link" href="#" role="tab" tabindex="0" aria-selected="true" aria-controls="color-picker-default">Default</a>
                </li>
                <li class="slds-tabs_default__item" title="Custom" role="presentation">
                  <a id="color-picker-custom__item" class="slds-tabs_default__link" href="#" role="tab" tabindex="-1" aria-selected="false" aria-controls="color-picker-custom">Custom</a>
                </li>
              </ul>
              ...
              <div id="color-picker-custom" class="slds-tabs_default__content slds-hide" role="tabpanel" aria-labelledby="color-picker-custom__item">
                <div class="slds-color-picker__custom">
                  ...
                  <div class="slds-color-picker__hue-and-preview">
                    ...
                    <input id="color-picker-input-range-3" type="range" class="slds-color-picker__hue-slider" min="0" max="360" value="208">
