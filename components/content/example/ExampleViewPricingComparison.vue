        ...
        <div class="flow-root bg-gray-900 py-16 sm:pt-32 lg:pb-0">
          <div class="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div class="relative mx-auto mt-10 grid max-w-md grid-cols-1 gap-y-8 lg:mx-0 lg:-mb-14 lg:max-w-none lg:grid-cols-3">
              ...
              <div class="relative rounded-2xl bg-gray-800/80 ring-1 ring-white/10 lg:bg-transparent lg:pb-14 lg:ring-0">
                <div class="p-8 lg:pt-12 xl:p-10 xl:pt-14">
                  <h2 id="tier-growth" class="text-sm font-semibold leading-6 text-white">
                    Growth
                  </h2>
                  <div class="flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between lg:flex-col lg:items-stretch">
                    <div class="mt-2 flex items-center gap-x-4">
              ...
              <div class="mx-auto max-w-2xl space-y-16">
                  ...
                  <div class="mt-10 space-y-10">
                    <div>
                      ...
                      <div class="relative mt-6">
                        ...
                        <!-- Fake card border -->
                        <div aria-hidden="true" class="pointer-events-none absolute inset-y-0 right-0 hidden w-1/2 rounded-lg ring-1 ring-gray-900/10 sm:block" />
                      </div>
                    </div>
                    <div>
                      <h4 class="text-sm font-semibold leading-6 text-gray-900">
                ...
                <div class="border-t border-gray-900/10">
                  <div class="-mt-px w-72 border-t-2 border-indigo-600 pt-10 md:w-80">
                    <h3 class="text-sm font-semibold leading-6 text-indigo-600">
                      Scale
                    </h3>
                    <p class="mt-1 text-sm leading-6 text-gray-600">
                  ...
                  <div class="mt-10 space-y-10">
                    <div>
                      ...
                      <div class="relative mt-6">
                        ...
                        <!-- Fake card border -->
                        <div aria-hidden="true" class="pointer-events-none absolute inset-y-0 right-0 hidden w-1/2 rounded-lg ring-2 ring-indigo-600 sm:block" />
                      </div>
                    </div>
                    <div>
                      <h4 class="text-sm font-semibold leading-6 text-gray-900">
                ...
                <div>
                  ...
                  <div class="relative -mx-8 mt-10">
                    ...
                    <div class="pointer-events-none absolute inset-x-8 inset-y-0 grid grid-cols-4 gap-x-8 before:block" aria-hidden="true">
                      ...
                      <div class="rounded-lg ring-2 ring-indigo-600" />
                      <div class="rounded-lg ring-1 ring-gray-900/10" />
                    </div>
                  </div>
                </div>
