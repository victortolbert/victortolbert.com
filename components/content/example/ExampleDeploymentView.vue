    ...
    <div class="xl:pl-72">
      ...
      <main class="lg:pr-96">
        <header class="flex items-center justify-between border-b border-white/5 px-4 py-4 sm:px-6 sm:py-6 lg:px-8">
          ...
          <!-- Sort dropdown -->
          <div class="relative">
            <button id="sort-menu-button" type="button" class="flex items-center gap-x-1 text-sm font-medium leading-6 text-white" aria-expanded="false" aria-haspopup="true">
              Sort by
          ...
          -->
            <div class="absolute right-0 z-10 mt-2.5 w-40 origin-top-right rounded-md bg-white py-2 shadow-lg ring-1 ring-gray-900/5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="sort-menu-button" tabindex="-1">
              ...
              <a id="sort-menu-item-0" href="#" class="block px-3 py-1 text-sm leading-6 text-gray-900" role="menuitem" tabindex="-1">Name</a>
        ...
        <ul role="list" class="divide-y divide-white/5">
          <li class="relative flex items-center space-x-4 px-4 py-4 sm:px-6 lg:px-8">
            ...
            <div class="flex-none rounded-full bg-gray-400/10 px-2 py-1 text-xs font-medium text-gray-400 ring-1 ring-inset ring-gray-400/20">
              Preview
            </div>
