...
import { g as asyncDataDefaults, h as useNuxtApp, c as createError, e as useRuntimeConfig } from '../server.mjs';
import { C as withLeadingSlash, j as joinURL, A as withoutTrailingSlash, D as withBase, B as hash } from '../../nitro/netlify.mjs';
import { a as useRequestEvent, u as useContentPreview } from './preview-VyZcW_HZ.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-9FHE-tYI.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-pFMQCUKC.mjs.map
