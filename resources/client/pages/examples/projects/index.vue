      ...
      <div class="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-white">
        ...
        <div class="absolute top-0 right-0 -mr-12 pt-2">
          ...
          >
            ...
            <vti-IconOutlined name="x" class="text-white" />
          </button>
        </div>
          ...
          <nav class="px-2">
            <div class="space-y-1">
              ...
              >
                ...
                -->
                <vti-IconOutlined name="home" class="text-gray-500 mr-3" />Home
              </a>
              ...
              >
                <vti-IconOutlined
                  name="view-list"
                  class="text-gray-400 group-hover:text-gray-500 mr-3"
                />My tasks
              </a>
                ...
                <span class="flex w-full justify-between items-center">
                  <span class="flex min-w-0 items-center justify-between space-x-3">
                    <img
                      ...
                      src="https://images.unsplash.com/photo-1502685104226-ee32379fefbe?ixlib=rb-1.2.1&ixqx=iXNbLPGHnb&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=3&w=256&h=256&q=80"
                      alt
                    />
          ...
          <div class="px-3 mt-5">
            ...
            <div class="mt-1 relative rounded-md shadow-sm">
              <div
                ...
                aria-hidden="true"
              >
                <vti-IconSolid name="search" class="text-gray-500 mr-3 h-4 w-4" />
              </div>
              <input
                type="text"
                name="search"
          ...
          <nav class="px-3 mt-6">
            <div class="space-y-1">
              ...
              >
                ...
                Current: "text-gray-500", Default: "text-gray-400 group-hover:text-gray-500"
                -->
                <vti-IconOutlined name="search" class="text-gray-500 mr-3" />Home
              </a>
    ...
    <div class="flex flex-col w-0 flex-1 overflow-hidden">
      ...
      >
        ...
        >
          ...
          <vti-IconOutlined name="menu-alt-1" />
        </button>
                ...
                <tr>
                  ...
                  <td class="pr-6">
                    <div class="relative flex justify-end items-center">
                      ...
                      >
                        <span class="sr-only">Open options</span>
                        <vti-IconSolid name="dots-vertical" />
                      </button>
