  ...
  <div class="flex flex-col shadow-lg overflow-hidden">
    <div class="flex-shrink-0">
      <img
        ...
        src="https://images.unsplash.com/photo-1547586696-ea22b4d4235d?ixlib=rb-1.2.1&amp;ixqx=iXNbLPGHnb&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=crop&amp;w=1679&amp;q=80"
        alt
      />
    </div>
    <div class="flex-1 bg-white p-6 flex flex-col justify-between">
      <div class="flex-1">
        ...
        <a href="#" class="block mt-2">
          ...
          >How to use search engine optimization to drive sales</p>
          <p
