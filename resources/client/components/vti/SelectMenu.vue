<template>
  <span class="inline-flex shadow-sm rounded-md divide-x divide-primary-600">
    <!--
    ...
    <div>
      ...
      <div class="relative">
        <div class="relative z-0 inline-flex shadow-sm rounded-md divide-x divide-primary-600">
          ...
          <button
            type="button"
            class="relative inline-flex items-center bg-primary-500 p-2 rounded-r-md text-sm font-medium text-white hover:bg-primary-600 focus:outline-none focus:z-10 focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-primary-500"
