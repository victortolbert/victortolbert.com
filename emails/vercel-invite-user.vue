  ...
  <ETailwind>
    <EHtml>
      ...
      <EBody class="mx-auto my-auto bg-white font-sans">
        <EContainer class="mx-auto my-[40px] max-w-[465px] border border-[#eaeaea] rounded border-solid p-[20px] md:p-7">
          <ESection class="mt-[32px]">
            <EImg src="images/examples/vercel-logo.png" width="40" height="37" alt="Vercel" class="mx-auto my-0" />
          </ESection>
          <EHeading class="mx-0 my-[30px] p-0 text-center text-[24px] font-normal text-black">
          ...
          <ESection>
            <ERow>
              <EColumn align="right">
                <EImg class="rounded-full" src="images/examples/vercel-user.png" width="64" height="64" />
              </EColumn>
              <EColumn align="center">
                <EImg src="images/examples/vercel-arrow.png" width="12" height="9" alt="invited you to" />
              </EColumn>
              <EColumn align="left">
                <EImg class="rounded-full" src="images/examples/vercel-team.png" width="64" height="64" />
              </EColumn>
            </ERow>
          </ESection>
          <ESection class="mb-[32px] mt-[32px] text-center">
            <EButton px="20" py="12" class="rounded bg-[#000000] text-center text-[12px] font-semibold text-white no-underline" :href="inviteLink">
              Join the team
            </EButton>
          </ESection>
          <EText class="text-[14px] leading-[24px] text-black">
          ...
          <EHr class="mx-0 my-[26px] w-full border border-[#eaeaea] border-solid" />
