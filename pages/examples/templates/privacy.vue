<template>
  <div class="relative -mt-[5.75rem] overflow-hidden pt-[5.75rem]">
    ...
    <div class="relative px-4 sm:px-6 lg:px-8">
      <div class="mx-auto max-w-[40rem] prose-sm prose prose-gray prose-a:font-semibold prose-a:text-primary-500 hover:prose-a:text-primary-600">
        <p>
          This privacy policy ("Policy") describes how VTi Consulting. ("VTi", "we", "us" or "our") collects, protects and uses the personally identifiable information ("Personal Information") you ("User", "you" or "your") may provide through the DesignCoder website (designcoder.net) or in the course of purchasing any DesignCoder products (collectively, "Website"). The Policy also describes the choices available to you regarding our use of your Personal Information and how you can access and update this information. This Policy does not apply to the practices of companies that we do not own or control, or to individuals that we do not employ or manage.
        </p>

        <h2>Collection of personal information</h2>

        <p>We receive and store any information you knowingly provide to us when you make a purchase through the Website. Currently this is limited to your email address, which is required for you to be able to login to the Website and access any purchased DesignCoder products.</p>
        ...
        <p>All purchases made through the Website are processed by a third party payment processor, Paddle (<a href="https://paddle.com">paddle.com</a>). Paddle may ask you for personal and/or non-personal information, such as your name, address, email address, credit card information, or other Personal Information. Paddle has a privacy policy (<a href="https://paddle.com/legal-buyers/">paddle.com/legal-buyers/</a>) that describes their collection and use of personal information. VTi does not control Paddle or its collection or use of information. Any questions or concerns about Paddle’s practices should be directed to Paddle.</p>
        ...
        <p>You are able to update your Personal Information in your "Account Settings" on the Website. Currently this is limited to just your email address, as described above. You may also request that we delete your email address, but this will prevent you from accessing the products you have purchased from VTi.</p>
        ...
        <p>Any requests to exercise User rights can be directed to the Owner by email at <a href="mailto:support@designcoder.net">support@designcoder.net</a>. These requests can be exercised free of charge and will be addressed by the Owner as early as possible and always within one month.</p>
        ...
        <p>If you have any questions about this Policy, please contact us by email at <a href="mailto:support@designcoder.net">support@designcoder.net</a>.</p>
      </div>
    </div>
  </div>
</template>
